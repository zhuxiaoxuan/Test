...
public class OkHttpClientManager {
     ...
     * @return
     */
    private Response _syncpost(String url, Param... params) throws IOException {
     ...
     * @return 字符串
     */
    private String _postSyncString(String url, Param... params) throws IOException {
        Response response = _syncpost(url, params);
     ...
     * @return
     */
    private Response _syncpost(String url, File[] files, String[] fileKeys, Param... params) throws IOException {
...
//        });
    ...
    public static Response syncpost(String url, Param... params) throws IOException {
        return getInstance()._syncpost(url, params);
    }

    public static String postSyncString(String url, Param... params) throws IOException {
        return getInstance()._postSyncString(url, params);
    }
    ...
    public static Response syncpost(String url, File[] files, String[] fileKeys, Param... params) throws IOException {
        return getInstance()._syncpost(url, files, fileKeys, params);
    }
